...
const names =  ['Amanda', 'David', 'Spiros']
    ...
    <div className="about-us-page">
        <div className="__about">
            <h1>About Us </h1>
            <div className="__developer-list">
                { names.map(developer)}
            </div>
         </div>
        ...
        <div className="__developer" >
                ...
                <img src={require('../../../img/profile.png').default} alt="" /> 
                    <div className="__info">
                        <h3>{name}</h3>
                        <p>Lorem ipsum, dolor sit amet consectetur adipisicing elit. Provident accusantium eveniet corporis dolor velit non saepe quibusdam officiis, enim, ullam itaque eaque beatae repellat cupiditate autem illum alias exercitationem similique.</p>
                    </div>
            </div>
    )
}