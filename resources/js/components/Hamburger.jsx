...
function Hamburger() {
    ...
    return (
        <div className="hamburger-container">
            <div className='hamburger'><FontAwesomeIcon onClick={toggleMenu} icon={open} size="2x"/></div>
            ...
            <ul className='nav-bar' onClick={toggleMenu}>
                ...
                <ul className='dropdown-mobile'>
                    <li className='city-dropdown-mobile'>
                        <Link to='/city/santorini' className='city-list-dropdown-mobile'>Santorini</Link>
                    </li>
                    <li className='city-dropdown-mobile'>
                        <Link to='/city/rio-de-janeiro' className='city-list-dropdown-mobile'>Rio de Janeiro</Link>
                    </li>
                    <li className='city-dropdown-mobile'>
                        <Link to='/city/warsaw' className='city-list-dropdown-mobile'>Warsaw</Link>
                    </li>
